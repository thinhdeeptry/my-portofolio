...
export default function Home() {
  return (
    <div className="w-full h-screen overflow-hidden relative bg-black flex flex-col justify-center">
      ...
      {/* Layout desktop với pointer-events-none */}
      <div className="relative z-10 hidden md:flex flex-row justify-between items-center w-full px-32 gap-4 pointer-events-none">
        {/* Các thẻ con được cho phép nhận sự kiện chuột */}
        <div className="self-start mt-14 pointer-events-auto">
          <AnimatedHeading />
    ...
    hover:shadow-lg hover:shadow-indigo-500/20 hover:scale-110 group">
      ...
      {/* Layout mobile với pointer-events-none */}
      <div className="relative z-10 flex md:hidden flex-col gap-8 items-center justify-center w-full px-4 pointer-events-none">
